...
class NANSDIFFICULTYSYSTEMUE4_API UNDifficultyAdapterBasic : public UNDifficultyAdapterAbstract
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class NANSDIFFICULTYSYSTEMUE4_API UNDifficultyAdapterResetFromReason : public UNDifficultyAdapterAbstract
{
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, Category = "DifficultySystem|Operation")
