...
struct FNDifficultyStateResult
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "DiffcicultySystem")
    float Time;
};

UCLASS(meta = (ScriptName = "DifficultyLibrary"))
class NANSFACTORSFACTORYUE4_API UNDifficultyFactory : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
     ...
     */
    UFUNCTION(BlueprintPure, Category = "FactorsFactory|Factory", meta = (WorldContext = "WorldContextObject", Keywords = "FactorsFactory get states factory", DisplayName = "Get states of difficulty"))
    static TMap<FName, FNDifficultyStateResult> GetDifficultyStates(UObject* WorldContextObject, TArray<FName> StackNames);
    
    UFUNCTION(BlueprintPure, Category = "FactorsFactory|Factory", meta = (WorldContext = "WorldContextObject", Keywords = "FactorsFactory get state factory", DisplayName = "Get a state of a difficulty"))
    static FNDifficultyStateResult GetDifficultyState(UObject* WorldContextObject, FName StackName);

    UFUNCTION(BlueprintCallable, Category = "FactorsFactory|Factory", meta = (WorldContext = "WorldContextObject", Keywords = "FactorsFactory reset states factory", DisplayName = "Clear difficulties"))
    ...
    UFUNCTION(BlueprintCallable, Category = "FactorsFactory|Factory", meta = (DevelopmentOnly, WorldContext = "WorldContextObject", Keywords = "FactorsFactory debug", DisplayName = "Debug Difficulties"))
